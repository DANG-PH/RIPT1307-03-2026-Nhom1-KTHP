...
|---|---|---|---|
| **Web Client (NextJS) & Game Client (Java)** | [dragonboy-web](https://github.com/DANG-PH/dragonboy-web) | TypeScript · Tailwind CSS | Web platform — shop, account market, leaderboard, chat, ví, AI chatbot |
