...
|---|---|---|---|
| **Client (Web & Game)** | [dragonboy-web](https://github.com/DANG-PH/dragonboy-web) | TypeScript (NextJS) · Tailwind CSS | Web platform — shop, account market, leaderboard, chat, ví, AI chatbot |
